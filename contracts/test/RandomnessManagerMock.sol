...
contract RandomnessManagerMock is VRFConsumerBaseV2 {
    ...
    function requestRandomWords() external returns (uint256) {
        ...
        //this is for mock only as we won't have a callback
        s_randomWords.push(random());
    ...
    function topUpSubscription(uint256 amount) external onlyOwner {
        // Fund for randomness subscription is NotRequired for Mock version
    }
